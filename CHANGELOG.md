...
- **Human Validation:** *Replacing Human Judgment* surfaced as a labeled paragraph under *Recommendations*. Adds a **must** disclosure (researchers must explain whether and how the replacement is justified) on top of the existing **should** to follow systematic approaches. Model-to-model agreement reframed as necessary-but-not-sufficient; qualitative-coding caveat added. The Study Types umbrella sentence echoes the conditional **must** for annotators, judges, synthesis, and subjects. Hosking et al. (ICLR 2024) and Chen et al. (EMNLP 2024) cited under *Challenges* on human-rater limitations.
