...
When LLMs automate research or software development tasks previously performed by humans, the LLM's performance needs to be assessed. When existing reference datasets or comparison metrics cannot fully capture the target qualities relevant in the study context, researchers \should rely on human judgment to validate the LLM outputs.
