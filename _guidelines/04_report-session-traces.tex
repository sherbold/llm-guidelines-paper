...
Non-determinism can arise from probabilistic sampling and, even with greedy decoding (temperature = 0), from batching, input preprocessing, floating-point arithmetic on GPUs, and the use of Mixture-of-Experts architectures~\cite{Chann2023}.
