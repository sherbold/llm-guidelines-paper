...
Non-determinism can arise from probabilistic sampling (unless temperature is set to 0), batching, input preprocessing, and floating-point arithmetic on GPUs~\cite{Chann2023}.
