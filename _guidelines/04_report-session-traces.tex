...
Agent-to-agent communication is not yet covered by widely-accepted formats or schemas (and the tooling that would build on them), so reporting practices vary across frameworks.
