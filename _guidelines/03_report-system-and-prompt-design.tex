...
For few-shot prompts, the examples provided to the model \must be clearly outlined, along with the rationale for selecting them. Concrete examples of the few-shot prompts \should be included in the \supplementarymaterial.
