...
Where prompts are published, they also change between releases~\cite{willison2026opus}, so researchers \must record the tool version and date of use even when the prompt content itself is unavailable.
