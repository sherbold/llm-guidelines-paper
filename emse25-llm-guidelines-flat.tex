...
Items prefixed with a bracketed tag apply only to studies with that feature (e.g., \condition{fine-tuning}, \condition{agents}).\ifpaper\else{} Readers can hover each tag to read its description and use the filter panel to hide items that do not apply to their study.\fi
