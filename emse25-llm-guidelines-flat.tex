...
% Paper: plain text. Website: bold for quick scanning.
\ifpaper
...
Table~\ref{tab:guideline-matrix}, which appears at the conclusion of this guideline section, provides an overview of how each guideline applies to each study type.
...
\hyperref[sec:report-model-version-configuration-and-customizations]{Model Version}
  ...
  & \iconM % subjects: "must report any persona-related configuration settings and parameters that shape the simulated behavior"
