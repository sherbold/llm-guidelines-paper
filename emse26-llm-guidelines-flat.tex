...
% GROUNDING: ``Synthetic instances were generated with OpenAI's GPT-4o'' (Section 2.3); ``We use o3-mini as the LLM judge'' (Section 3.3); list of nine evaluated models in Section 4.1.
...
% GROUNDING: ``We open-source the 1,800-instance benchmark and evaluation code.'' ``[Ministral 3B as] a representative compact open model.'' (Section 1 and Section 4.1)
