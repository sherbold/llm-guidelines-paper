...
\begin{itemize}[label={},leftmargin=*]
    ...
    \item \iconM \condition{human-validation} When LLMs replace, rather than augment, humans in research tasks, explain in the \paper whether and how the replacement is justified~(\refhumanvalidation).
