...
\newline \iconS When LLMs replace, rather than augment, humans in research tasks, ground the replacement with model-to-model and model-to-human agreement. \\
\addlinespace
...
\begin{itemize}[label={},leftmargin=*]
    ...
    \item \iconS \condition{human-validation} When LLMs replace, rather than augment, humans in research tasks, report in the \paper the systematic approach used to justify the replacement, including model-to-model and model-to-human agreement~(\refhumanvalidation).
